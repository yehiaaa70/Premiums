...
import com.example.premiums.RoomDatabase.AsyncTask.PersonalAsync.DeletePersonal_Async;
...
public class HomePageFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        showBtn = view.findViewById(R.id.add_user_Fbtn);
    ...
    private void RecyclerViw_Listener() {
        userCard_adapter = new UserCard_Adapter(card_models, requireContext(), new UserCard_Adapter.OnUserCardClick() {
            ...
            public void onDetailsClick(View view, int position) {
                ...
                findNavController(view).navigate(R.id.action_homePageFragment_to_detailsFragment, bundle);
    ...
    // All Listener Of That Fragment
    private void AllClickListener() {

        showBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_homePageFragment_to_newCustomerFragment);
            }
        });
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0 && showBtn.getVisibility() == View.VISIBLE) {
                    showBtn.hide();
                } else if (dy < 0 && showBtn.getVisibility() != View.VISIBLE) {
                    showBtn.show();
                }
            }
        });
    ...
    private void DeleteCustomer(int position) {
        Information_Users_Model information_users_model = model.get(position);
        new DeletePersonal_Async(RoomFactory.getPersonalDatabase(requireContext()).getPersonalDAO()).execute(information_users_model);
        userCard_adapter.notifyDataSetChanged();
        GetData();
        showOrHideNoteImage();
    }
